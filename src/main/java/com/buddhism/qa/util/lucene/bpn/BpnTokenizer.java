 ...
 */
public class BpnTokenizer extends Tokenizer {
    ...
    public BpnTokenizer(Analysis ta, List<StopRecognition> stops, List<SynonymsRecgnition> synonyms) {
        this.ta = ta;
        this.stops = stops;
        this.synonyms = synonyms;
        ta.setForests(Segmentor.getDics());
    }
