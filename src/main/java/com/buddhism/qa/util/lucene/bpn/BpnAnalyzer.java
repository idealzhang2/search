 ...
 */
public class BpnAnalyzer extends Analyzer {
    public static final Log LOG = LogFactory.getLog();
    private Map<String, String> args;

    public BpnAnalyzer(Map<String, String> args) {
        this.args = args;
    }

    public BpnAnalyzer(BpnAnalyzer.TYPE type, String dics) {
        this.args = new HashMap();
        this.args.put("type", type.name());
        this.args.put("dic", dics);
    }

    public BpnAnalyzer(BpnAnalyzer.TYPE type) {
        this.args = new HashMap();
        this.args.put("type", type.name());
    }
    ...
    public static Tokenizer getTokenizer(Reader reader, Map<String, String> args) {
        ...
        if(type == null) {
            type = BpnAnalyzer.TYPE.BASE.name();
        }
        ...
        switch(TYPE.valueOf(type).ordinal()) {
            ...
            case 2:
                ...
                analysis1.setForests(Segmentor.getDics());
                analysis = analysis1;
                break;
            case 3:
                //添加词典
        ...
        return new BpnTokenizer((Analysis)analysis, var13, var15);
    }
